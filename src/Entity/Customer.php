...
class Customer
{
	 ...
	 * @Assert\Length(allowEmptyString=true, min=3, minMessage="Le prénom doit faire entre 3 et 255 caractères",
	 *     max=255,
	 ...
	 * @Assert\Length(allowEmptyString=true, min=3, minMessage="Le nom doit faire entre 3 et 255 caractères",
